...
export function initDb() {
  ...
  stratInsert.run('graduate_entry', 'Graduate Entry (Pullback)', 0, JSON.stringify({
    entry_mode: 'wait_for_dip',
    min_source_count: 1,
    require_fee_claim: false,
    token_age_max_ms: 1_800_000,
    min_mcap_usd: 12000,
    max_mcap_usd: 80000,
    min_fee_claim_sol: 0,
    min_gmgn_total_fee_sol: 0,
    ...
    min_graduated_volume_usd: 0,
    trending_min_volume_usd: 8000,
    trending_min_swaps: 80,
    trending_max_rug_ratio: 0.20,
    trending_max_bundler_rate: 0.25,
    min_graduated_age_ms: 480_000,
    max_graduated_age_ms: 1_500_000,
    position_size_sol: 0.1,
    max_open_positions: 2,
    tp_percent: 55,
    sl_percent: -15,
