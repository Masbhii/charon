...
export async function handleMessage(msg) {
  ...
  if (text.startsWith('/strategy')) {
    ...
    const valid = ['sniper', 'dip_buy', 'smart_money', 'degen', 'graduate_immediate', 'graduate_entry'];
